...
export interface IPluginKeychainAwsSmRemoteAdapterOptions
 ...
 */
export class PluginKeychainAwsSmRemoteAdapter
  implements ICactusPlugin, IPluginWebService {
  public static readonly CLASS_NAME = "PluginKeychainAwsSmRemoteAdapter";
  ...
  constructor(public readonly opts: IPluginKeychainAwsSmRemoteAdapterOptions) {
