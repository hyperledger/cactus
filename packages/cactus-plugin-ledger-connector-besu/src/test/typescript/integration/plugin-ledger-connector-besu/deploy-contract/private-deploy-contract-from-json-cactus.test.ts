...
test(testCase, async (t: Test) => {
  ...
  keychain1.set(HelloWorldContractJson.contractName, HelloWorldContractJson);
  ...
  keychain2.set(HelloWorldContractJson.contractName, HelloWorldContractJson);
  ...
  keychain3.set(HelloWorldContractJson.contractName, HelloWorldContractJson);
